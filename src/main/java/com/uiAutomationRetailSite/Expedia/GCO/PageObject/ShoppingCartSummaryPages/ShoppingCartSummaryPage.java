package com.uiAutomationRetailSite.Expedia.GCO.PageObject.ShoppingCartSummaryPages;
...
public class ShoppingCartSummaryPage {
	...
	public ShoppingCartSummaryPage(WebDriver driver) {
		...
		waitHelper.waitForElement(yourShoppingCart,ObjectReader.reader.getExplicitWaitValueFromPropertyFile());
	}
	...
	public boolean verifyProduct(String prod) {
		...
		return new VerificatinHelper(driver).isDisplayed(product);
	}
	...
	public boolean verifyEmptyShoppingCartMesssage() {
		return new VerificatinHelper(driver).isDisplayed(emptyShoppingCartMsg);
	}
