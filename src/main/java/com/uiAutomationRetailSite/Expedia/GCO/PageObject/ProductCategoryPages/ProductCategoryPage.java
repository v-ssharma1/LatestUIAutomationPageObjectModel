package com.uiAutomationRetailSite.Expedia.GCO.PageObject.ProductCategoryPages;
...
import com.uiAutomationRetailSite.Expedia.GCO.Helper.DropDown.DropDownHelper;
...
public class ProductCategoryPage {
	...
	public ProductCategoryPage(WebDriver driver) {
		...
		waitHelper.waitForElement(catalogTextObj, ObjectReader.reader.getExplicitWaitValueFromPropertyFile());
		TestBase.logExtentReport("ProductCategoryPage object creatd...");
		new TestBase().getNavigationScreen(driver);
	}

	public void mouseOverOnProduct(int number) {
		//div[@id='center_column']/ul/li[1]//a/img/parent::a
