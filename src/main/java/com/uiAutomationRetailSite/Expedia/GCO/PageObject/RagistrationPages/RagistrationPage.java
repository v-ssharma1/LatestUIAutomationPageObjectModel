package com.uiAutomationRetailSite.Expedia.GCO.PageObject.RagistrationPages;
...
public class RagistrationPage {
	...
	private final Logger log = LoggerHelper.getLogger(RagistrationPage.class);
	...
	public RagistrationPage(WebDriver driver) {
		...
		waitHelper.waitForElement(mrRadioButton, ObjectReader.reader.getExplicitWaitValueFromPropertyFile());
